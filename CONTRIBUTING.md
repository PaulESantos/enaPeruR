...
This outlines how to propose a change to enaPeruR. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("PaulESantos/enaPeruR", fork = TRUE)`.
...
Please note that the enaPeruR project is released with a [Contributor
Code of
Conduct](https://paulesantos.github.io/enaPeruR/CODE_OF_CONDUCT.md). By
