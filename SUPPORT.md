...
Thanks for using enaPeruR! Before filing an issue, there are a few
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/PaulESantos/enaPeruR/issues/new).
...
requests](https://github.com/PaulESantos/enaPeruR/issues) to make sure
